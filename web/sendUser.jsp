                            ...
                            <section class="panel">
                                <div class="panel-body">
                                    <ul class="nav nav-pills nav-stacked mail-nav">
                                        <li ><a href="inboxUser.jsp"> <i class="fa fa-inbox"></i> Inbox </a></li>
                                        <li class="active"><a href="sendUser.jsp"> <i class="fa fa-envelope-o"></i> Send Mail</a></li>
                            ...
                            <section class="panel">
                                ...
                                <div class="panel-body minimal">
                                    <div class="mail-option">
                                        ...
                                        <div class="btn-group">
                                            <form action="LoadUserSendAction" method="POST">
                                                <input type="hidden" name="sendID" value="<s:property value="%{#session.User.userID}"/>"/>
                                                        ...
                                                        <table class="table table-striped table-advance table-hover">
                                                                ...
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th class="hidden-phone"><i class="fa fa-question-circle"></i>The Device needs repair</th>
                                                                        <th><i class="fa fa-toggle-left "></i>Time</th>
