                            ...
                            <section class="panel">
                                <div class="panel-body">
                                    <ul class="nav nav-pills nav-stacked mail-nav">
                                        <li class="active"><a href="repairer.jsp"> <i class="fa fa-inbox"></i>Request repairs</a></li>
                                        <li><a href="repairManager.jsp"> <i class="fa fa-envelope-o"></i>My Repair Manager</a></li>
                                                                ...
                                                                <s:iterator value="listRequest" status="counter" >
                                                                    <tr>
                                                                        ...
                                                                        <td><s:property value="time"></s:property> </td>
                                                                            <th>
                                                                                <form action="ConfrimRepairAction" method="POST">
                                                                                    <input type="hidden" name="userID" value="<s:property value="sender"></s:property>"/>
