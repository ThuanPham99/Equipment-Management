                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li class="active" ><a href="crudDevice.jsp">Devices</a></li>
                            </ul>
                        </li>
                ...
                <section class="wrapper">
                    ...
                    <div class="row mt">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                               <label class="control-label col-md-3">Create a Device</label>
                               <a href="createDevice.jsp">
                                            ...
                                            <s:iterator value="listDevice" status="counter" >
                                                <tr>
                                                    ...
                                                    <td><span class="label label-warning label-mini">
                                                        ...
                                                        <td>
                                                            <form action="EditDeviceAction" method="POST">                                                                
                                                        ...
                                                        <th>
                                                            <form action="DeleteDeviceAction" method="POST">
                                                                <input type="hidden" name="ID" value=" <s:property value="ID"></s:property>"/>
                                                                <input type="hidden" name="searchDevice" value="${requestScope.SearchDevice}"/>
