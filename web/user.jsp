                    ...
                    <div class="row mt">
                        ...
                        <div class="col-lg-12">
                            <div class="form-panel">
                                <form action="UserSearchDeviceAction" class="form-horizontal style-form" method="POST">

                                    <div class="form-group">
                                        <label class="control-label col-md-3">Device ID</label>
                                        <div class="col-md-3 col-xs-11">
                                            <input type="hidden" name="room" value="<s:property value="%{#session.User.room}"/>" />
                                    ...
                                    <table class="table table-striped table-advance table-hover">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Device needs repair</th>
                                                <th>Locate History</th>
                                        ...
                                        <tbody>
                                            ...
                                            <s:iterator value="listDevice" status="counter" >
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="RequestRepairAction" method="POST">
                                                            <input type="hidden" name="status" value="<s:property value="status"/>"/>
                                                            <input type="hidden" name="sender" value="<s:property value="%{#session.User.userID}"/>"/>
                                                        ...
                                                        <th>
                                                            <form action="ViewLocationHistoryAction" method="POST">
